...
<Panel id = "timedEffectsCreationPanel" offsetXY = "-150 -70" width = "0" height = "0" raycastTarget = "false" padding = "0.0, 0.0, 0.0, 0.0" allowDragging = "true" returnToOriginalPositionWhenReleased = "false">
    <VerticalLayout spacing = "5" childForceExpandHeight = "false" childForceExpandWidth = "false" childAlignment = "middleCenter">
        ...
        <InputField id = "timed_effect_effect" minHeight = "32" minWidth = "300" visibility = "host" onEndEdit = "addTimedEffectEffect" active = "false" placeholder = "Effect:" fontStyle = "bold"></InputField>
        <InputField id = "timed_effect_targets" minHeight = "32" minWidth = "300" visibility = "host" onEndEdit = "addTimedEffectTargets" active = "false" placeholder = "Target(s):" fontStyle = "bold"></InputField>
        <HorizontalLayout spacing = "10" childForceExpandHeight = "false" childForceExpandWidth = "false" childAlignment = "middleCenter">
            <InputField id = "timed_effect_duration" minHeight = "32" minWidth = "130" visibility = "host" onEndEdit = "addTimedEffectDuration" active = "false" placeholder = "Rounds:" fontStyle = "bold"></InputField>
            <InputField id = "timed_effect_duration_minutes" minHeight = "32" minWidth = "130" visibility = "host" onEndEdit = "addTimedEffectDurationMinutes" active = "false" placeholder = "Minutes:" fontStyle = "bold"></InputField>
        </HorizontalLayout>
        <HorizontalLayout spacing = "10" childForceExpandHeight = "false" childForceExpandWidth = "false" childAlignment = "middleCenter">
            <InputField id = "timed_effect_duration_hours" minHeight = "32" minWidth = "130" visibility = "host" onEndEdit = "addTimedEffectDurationHours" active = "false" placeholder = "Hours:" fontStyle = "bold"></InputField>
            <InputField id = "timed_effect_duration_days" minHeight = "32" minWidth = "130" visibility = "host" onEndEdit = "addTimedEffectDurationDays" active = "false" placeholder = "Days:" fontStyle = "bold"></InputField>
        </HorizontalLayout>
